...
export const adminApi = {
  ...
  chat: {
    conversations: (params?: Query) => http.get("/admin/chat/conversations", { params }),
    conversation: (id: string) => http.get(`/admin/chat/conversations/${id}`),
    messages: (id: string, params?: Query) => http.get(`/admin/chat/conversations/${id}/messages`, { params }),
    flagMessage: (id: string, data: unknown) => http.patch(`/admin/chat/messages/${id}/flag`, data),
    takeover: (id: string, data: unknown) => http.post(`/admin/chat/conversations/${id}/takeover`, data),
    close: (id: string) => http.post(`/admin/chat/conversations/${id}/close`),
    dashboard: (params?: Query) => http.get("/admin/chat/dashboard", { params }),
    userStats: (params?: Query) => http.get("/admin/chat/analytics/user-stats", { params }),
    topProductsAsked: (params?: Query) => http.get("/admin/chat/analytics/top-products-asked", { params }),
    topQuestions: (params?: Query) => http.get("/admin/chat/analytics/top-questions", { params }),
    kbEffectiveness: () => http.get("/admin/chat/analytics/kb-effectiveness"),
    sourceComparison: (params?: Query) => http.get("/admin/chat/analytics/source-comparison", { params }),
    revenue: (params?: Query) => http.get("/admin/chat/analytics/revenue", { params }),
    sensitiveQuestions: (params?: Query) => http.get("/admin/chat/sensitive-questions", { params }),
    createSensitiveQuestion: (data: unknown) => http.post("/admin/chat/sensitive-questions", data),
    updateSensitiveQuestion: (id: string, data: unknown) => http.put(`/admin/chat/sensitive-questions/${id}`, data),
    deleteSensitiveQuestion: (id: string) => http.delete(`/admin/chat/sensitive-questions/${id}`),
    kbVersions: () => http.get("/admin/chat/kb-versions"),
    createKbVersion: (data: unknown) => http.post("/admin/chat/kb-versions", data),
  },
